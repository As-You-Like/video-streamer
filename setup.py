...
setup(
    ...
    package_data={"": ["*.ui", "*.png", "*.qrc", "*.rcc"], "vstreamer": ["resources/*", "resources/icons/*"]},
    scripts=["bin/video_streamer.py", "bin/video_streamer_server.py", "bin/video_streamer_setter.py"],
