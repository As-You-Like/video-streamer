...
class FileEntryVM:
    def __init__(self, filename, is_video, properties=None, other_properties=None):
        super().__init__()
        ...
        if other_properties is None:
            other_properties = OrderedDict()
        self.other_properties = other_properties

    @staticmethod
    def from_file_entry(dir_info: DirectoryInfo):
        return list(map(lambda file_entry:
                        FileEntryVM(file_entry.filename, file_entry.is_video, file_entry.properties,
